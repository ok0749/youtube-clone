...
!function (t) {
  ...
  if (e(8)) {
    ...
    h(Wt, Ct), p(Wt, vt, Ct.values), h(Wt, {
      ...
      x ? (v = e(function (t, e, r, o) {
        ...
        if (w(e)) {
          if (!(e instanceof $ || "ArrayBuffer" == (a = b(e)) || "SharedArrayBuffer" == a)) return xt in e ? Mt(v, e) : At.call(v, e);
          i = e, h = _t(r, n);
          var g = e.byteLength;
        ...
        var i;
        return s(t, v, f), w(e) ? e instanceof $ || "ArrayBuffer" == (i = b(e)) || "SharedArrayBuffer" == i ? void 0 !== o ? new g(e, _t(r, n), o) : void 0 !== r ? new g(e, _t(r, n)) : new g(e) : xt in e ? Mt(v, e) : At.call(v, e) : new g(y(e));
  ...
  if (u.ABV) {
    ...
    var $ = new _x(new _m2(2)),
        X = _x.prototype.setInt8;
    $.setInt8(0, 2147483648), $.setInt8(1, 2147483649), !$.getInt8(0) && $.getInt8(1) || a(_x.prototype, {
  ...
  var r = e(1),
    ...
    return n._k = t, n;
      ...
      X = G && "symbol" == _typeof(_I.iterator) ? function (t) {
    return "symbol" == _typeof(t);
  } : function (t) {
    return t instanceof _I;
  },
      Y = function Y(t, n, e) {
    return t === V && Y(W, n, e), m(t), n = S(n, !0), m(e), o(D, n) ? (e.enumerable ? (o(t, k) && t[k][n] && (t[k][n] = !1), e = _(e, {
      enumerable: E(0, !1)
  ...
  G || (c((_I = function I() {
    ...
    return this._k;
  }), P.f = Z, M.f = Y, e(35).f = O.f = Q, e(46).f = K, j.f = tt, i && !e(31) && c(V, "propertyIsEnumerable", K, !0), v.f = function (t) {
    return $(h(t));
  }), u(u.G + u.W + u.F * !G, {
    Symbol: _I
  });
  ...
  u(u.S + u.F * it, "Object", {
    ...
    stringify: function stringify(t) {
      ...
      if (e = n = r[1], (x(n) || void 0 !== t) && !X(t)) return g(n) || (n = function n(t, _n) {
        if ("function" == typeof e && (_n = e.call(this, t, _n)), !X(_n)) return _n;
      }), r[1] = n, R.apply(N, r);
    }
  ...
  var e = document.getElementById("jsRecordContainer"),
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              u.stop(), r.innerHTML = "Start Recording", (t = o).srcObject.getTracks().forEach(function (t) {
                t.stop();
              }), t.srcObject = null, r.addEventListener("click", f), r.removeEventListener("click", a);
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              t = _context2.sent;
              o.srcObject = t, o.muted = !0, o.play(), i = t, u = new MediaRecorder(i), u.start(), r.innerHTML = "Stop Recording", u.addEventListener("dataavailable", c), r.addEventListener("click", a);
              _context2.next = 10;
              break;
  ...
  var r = e(131),
      o = e.n(r);
  var i = document.getElementById("jsVideoPlayer"),
      u = document.querySelector("#jsVideoPlayer video"),
      c = document.getElementById("jsPlayButton"),
      a = document.getElementById("jsVolumeBtn"),
      f = document.getElementById("jsFullScreen"),
      s = document.getElementById("currentTime"),
      l = document.getElementById("totalTime"),
      p = document.getElementById("jsVolume");

  function h() {
    document.exitFullscreen(), f.innerHTML = '<i class="fas fa-expand"></i>', f.removeEventListener("click", h), f.addEventListener("click", v);
  }

  function v() {
    i.requestFullscreen(), f.innerHTML = '<i class="fas fa-compress"></i>', f.removeEventListener("click", v), f.addEventListener("click", h);
  }

  function d() {
    u.muted ? (u.muted = !1, a.innerHTML = '<i class="fas fa-volume-up"></i>', p.value = u.volume) : (p.value = 0, u.muted = !0, a.innerHTML = '<i class="fas fa-volume-mute"></i>');
  }

  function y() {
    u.paused ? (u.play(), c.innerHTML = '<i class="fas fa-pause"></i>') : (u.pause(), c.innerHTML = '<i class="fas fa-play"></i>');
  }
  ...
  var g = function g(t) {
    ...
    var e = Math.floor(n / 3600),
        ...
        o = n - 3600 * e - 60 * r;
    return e < 10 && (e = "0" + e), r < 10 && (r = "0" + r), t < 10 && (o = "0" + o), "".concat(e, ":").concat(r, ":").concat(o);
  };

  function m() {
    s.innerHTML = g(Math.floor(u.currentTime));
  }
  ...
  function _x2() {
    _x2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      var t, n;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return fetch(u.src).then(function (t) {
                return t.blob();
              });
            ...
            case 5:
              n = _context4.sent;
              l.innerHTML = g(n), setInterval(m, 1e3);
  ...
  function b() {
    ...
    })(), u.currentTime = 0, c.innerHTML = '<i class="fas fa-play"></i>';
  }

  function w(t) {
    var n = t.target.value;
    u.volume = n, a.innerHTML = n > .5 ? '<i class="fas fa-volume-up"></i>' : n > .1 ? '<i class="fas fa-volume-down"></i>' : '<i class="fas fa-volume-off"></i>';
  }

  i && (u.volume = "0.5", c.addEventListener("click", y), a.addEventListener("click", d), f.addEventListener("click", v), u.addEventListener("loadedmetadata", x), u.addEventListener("ended", b), p.addEventListener("input", w));
  e(323);
  var S = e(132),
      E = e.n(S);

  var _ = document.getElementById("jsAddComment"),
      O = document.getElementById("jsCommentList"),
      P = document.getElementById("jsCommentNumber"),
      j = function j(t) {
    var n = document.createElement("li"),
        e = document.createElement("span");
    e.innerHTML = t, n.appendChild(e), O.prepend(n), P.innerHTML = parseInt(P.innerHTML, 10) + 1;
  },
      M = function M(t) {
    t.preventDefault();

    var n = _.querySelector("input");
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                n = window.location.href.split("/videos/")[1];
                _context3.next = 3;
                return E()({
                  url: "/api/".concat(n, "/comment"),
                  method: "POST",
                  data: {
                    comment: t
                  }
              ...
              case 3:
                _context3.t0 = _context3.sent.status;
                _context3.t1 = 200 === _context3.t0;
